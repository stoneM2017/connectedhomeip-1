...
public:
    ...
    enum app_event_t {
        ...
        APP_EVENT_BTN_FACTORY_RESET         = 0x00000002,
        APP_EVENT_BTN_FACTORY_RESET_CANCEL  = 0x00000004,

        APP_EVENT_INIT_ALL_MASK             = APP_EVENT_STARTED 
            | APP_EVENT_BTN_FACTORY_RESET | APP_EVENT_BTN_FACTORY_RESET_CANCEL,
        ...
        APP_EVENT_ALL_MASK                  = APP_EVENT_LIGHTING_MASK | APP_EVENT_INIT_ALL_MASK | APP_EVENT_SYS_ALL_MASK | APP_EVENT_TIMER,
    };

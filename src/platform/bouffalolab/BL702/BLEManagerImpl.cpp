...
_bt_gatt_ccc CHIPoBLEChar_TX_CCC = BT_GATT_CCC_INITIALIZER(nullptr, ::chip::DeviceLayer::Internal::BLEManagerImpl::HandleTXCCCWrite, nullptr);
...
CHIP_ERROR BLEManagerImpl::StartAdvertising(void)
{
    ...
    err = bt_le_adv_start(&advParams, ad, sizeof(ad)/sizeof(ad[0]), nullptr, 0u);
    VerifyOrReturnError(err == 0, MapErrorZephyr(err));
